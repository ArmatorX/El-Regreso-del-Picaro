...
namespace Tests
{
    public class EquipoUnitTests
    {
        ...
        [Test]
        public void Equipo_equiparObjeto_SiEquipoLlenoDevuelveExcepciónOperaciónInválida()
        {
        ...
        [Test]
        public void Equipo_equiparObjeto_SiObjetoNoEsEquipableDevuelveExcepciónOperaciónInválida()
        {
            ObjetoAgarrable objeto = new ObjetoAgarrable();

            try
            {
                equipo.equiparObjeto(objeto);
                Assert.Fail();
            }
            catch (InvalidOperationException e)
            {
        ...
        /*
         * TODO: Esto es un test de integración.
        [Test]
        public void Equipo_armaEquipadaEsCuerpoACuerpo_DevuelveVerdaderoSiEsCuerpoACuerpo()
        {
            equipo.ArmaEquipada = arma;

            Assert.IsTrue(equipo.armaEquipadaEsCuerpoACuerpo());
        }
        */
        ...
        [Test]
        public void Equipo_calcularDañoBase_DevuelveValorCorrecto()
        {
            equipo.ArmaEquipada = arma;
